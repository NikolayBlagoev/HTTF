...
system_prompt_mean = """A conversation between User and Assistant. The user asks a question, and the Assistant solves it.
...
@torch.no_grad()
def generate_mean(model, tokenizer, q:str, num_rollouts = 6, modify_answer = None):
